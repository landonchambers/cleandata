...
\usepackage[T1]{fontenc}%Also needed this an next use package statement for this to run
\usepackage{lmodern}% See https://tex.stackexchange.com/questions/10706/pdftex-error-font-expansion-auto-expansion-is-only-possible-with-scalable
% Note: if microtype causes error on ubuntu, run
% sudo apt-get install cm-super
\title{Data Cleaning}
\author{Landon Chambers\\Wei-Ta Chen}
\date{}
